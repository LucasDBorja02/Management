...
class ControleVendasApp:
    def __init__(self, root):
        ...
        # Atalho para sair do modo tela cheia usando "ESC"
        ...
        janela_menu.add_command(label="Sair do Modo Tela Cheia", command=self.sair_tela_cheia)
    ...
    def sair_tela_cheia(self, event=None):
        """Função para sair do modo tela cheia e restaurar a janela"""
